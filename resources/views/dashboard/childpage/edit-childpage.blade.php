    ...
    <div class="grid-form1">
        ...
        <form class="form-horizontal" action="{{ route('childpage.update') }}" method="POST">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-2 text-right"> <label for="child">Parent Page</label></div>
                    <div class="col-sm-10">
                        <select name="parentpage_id" id="parentpage_id" class="form-select form-select-sm" value="{{ $childpage->parentpage_id }}" >
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <input type="text"  id="title" name="title" value="{{ $childpage->child_title }}" placeholder="Enter page title" required>
