    ...
    <div class="row">
        <div class="col-lg-9 margin-tb">
            ...
            <div class="pull-left" style="margin-top: 10px;">
                <a class="btn btn-primary" href=" {{ url('/add-adviser') }}"> Add New Adviser</a>
            </div>
        </div>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/edit-adviser/{{ $team->id}}" class="btn btn-info">Edit </a>
                    <a href="/delete-adviser/{{$team->id}}" class="btn btn-danger">Delete </a>
                </td>
