        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10 col-md-10 col-12">
                    <p class="logo-text">Nurse Career Promotion is a trusted learning center for NCLEX-RN exam
                        preparation in Nepal. </p>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="single-widget about">
                        ...
                        <ul class="list">
                            ...
                            <li><i class="fa fa-envelope"></i>Email: <a
                                    href="mailto:Info@nursecareerpromotion.com">Info@nursecareerpromotion.com</a>
                            </li>
                            <li><i class="fa fa-map-o"></i>Address: <br> 3455 N Beltline Rd, St 204, Irving, Dallas
                                TX 75062</li>
                        </ul>
                    </div>
                    <!--/ End About -->
                    ...
                    <div class="bottom-head">
                        <div class="row">
                            <div class="col-12">
                                <!-- Copyright -->
                                <div class="copyright">
                                    <p>© Copyright 2022 <a href="#">Nurse Career Promotion</a>.<a
                                            href="https://SiyZo.com">Managed by SiyZo</a>.</p>
                                </div>
                                <!--/ End Copyright -->
                            </div>
                        </div>
